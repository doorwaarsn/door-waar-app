...
const Home = () => {
  ...
  return (
      <div className="w-full h-auto flex flex-col gap-6 items-start pb-10">
        ...
        <div className="w-full flex justify-between items-center py-4 flex-wrap">
          {MenuCardDatas.map((item, i) => (
              <MenuCard key={i} datas={item} className="flex-1 min-w-[200px]"/>
          ))}
        </div>
        <div className="w-full flex flex-col lg:flex-row justify-center items-center gap-5">
          <div
              className="flex-1 h-[444px] pt-[16px] pb-[20px] rounded-[8px] border border-[#eff4fa] bg-[#fff] flex flex-col gap-5 px-5">
        ...
        <div className="w-full flex flex-col lg:flex-row justify-center items-center gap-5">
          <div className="flex-1 h-auto flex flex-col lg:flex-row justify-between items-center gap-5">
            <Performance/>
            <GrowthChart/>
          </div>
          <div
