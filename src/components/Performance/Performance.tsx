...
const Performance = () => {
  return (
    <div className="flex-1 h-[444px] p-5 rounded-[8px] border border-[#eff4fa] bg-[#fff] flex flex-col gap-5  items-center">
        ...
        <div className="space-y-5 w-full">
          {ProgressData.map((item, index) => (
            <div key={index}>
              ...
              >
                <div
                  className={`flex flex-col h-[8px] justify-center rounded-full bg-[${item.color}] text-xs text-white text-center whitespace-nowrap transition duration-500`}
